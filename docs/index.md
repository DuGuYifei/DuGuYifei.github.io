...
hero:
  name: My Name：
  text: Yifei Liu, Tobi
  tagline: •&nbsp;&nbsp;&nbsp;&nbsp;Backend DevOps<br>•&nbsp;&nbsp;&nbsp;&nbsp;Data Engineer<br>•&nbsp;&nbsp;&nbsp;&nbsp;Game Engineer
  image:
    src: /logo.png
    alt: DuGuYife
  actions:
